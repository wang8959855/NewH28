...
- (nullable UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    [button setTitle:NSLocalizedString(@"添加时间", nil) forState:UIControlStateNormal];
...
- (void)addBtnAction
{
    ...
    {
        [self addActityTextInView:self.view text:NSLocalizedString(@"最多可添加6个时间", nil) deleyTime:1.5f];
        return;
    }
    if (!_backView)
    {
