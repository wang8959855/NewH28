...
- (void)drawRect:(CGRect)rect
{
    ...
    if (!self.num1label) {
        ...
        self.num1label.textColor = numColor;
    ...
    if (!self.num2label) {
        ...
        self.num2label.textColor = numColor;
    ...
    if (!self.num3label) {
        ...
        self.num3label.textColor = numColor;
        self.num3label.textAlignment = NSTextAlignmentCenter;
        self.num3label.size = CGSizeMake(50, 20);
        self.num3label.center = CGPointMake(self.width-45, self.height+2);
    ...
    if (!self.num4label) {
        ...
        self.num4label.textColor = numColor;
    ...
    if (!self.num5label) {
        ...
        self.num5label.textColor = numColor;
...
- (void)setMaxValue:(CGFloat)maxValue
{
    if (_maxValue != maxValue && maxValue > _minValue) {
        ...
        self.comLabel.text = [NSString stringWithFormat:@"%@ %d%%",@"完成度",(int)com];
